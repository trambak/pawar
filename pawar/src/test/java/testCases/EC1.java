...
public class EC1 extends BaseClass {
	@Test
	public void editcust() throws IOException {
		...
		driver.findElement(By.xpath("/html/body/div[2]/table/tbody/tr/td/table/tbody/tr[6]/td[2]/input")).click();
		driver.findElement(By.xpath("/html/body/div[2]/table/tbody/tr/td/table/tbody/tr[11]/td[2]/input[1]")).click();

		if (driver.getPageSource().contains("Customer ID is required")) {
	...
	@Test
	public void editcust1() throws IOException {
